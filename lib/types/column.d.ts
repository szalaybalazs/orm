import { DefaultFunction, eAllTypes, eBinaryType, eBooleanType, eDateTypes, eEnumType, eIntervalType, eJSONTypes, eNumberType, eStringType, eUUIDType } from './datatypes';
...
export type tRegularColumn = iNumberColumn | iStringColumn | iUUIDColumn | iDateColumn | iBinaryColumn | iIntervalColumn | iBooleanColumn | iEnumColumn | iJSONColumn;
...
export type eColumnKeys = keyof iNumberColumn | keyof iStringColumn | keyof iUUIDColumn | keyof iDateColumn | keyof iBinaryColumn | keyof iIntervalColumn | keyof iBooleanColumn;
