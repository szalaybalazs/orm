...
exports.generateEntityTypes = void 0;
...
var generateEntityTypes = function (program) {
    (0, options_1.addOptions)(program.command('types:generate'))
        .description('Generate entity types')
        .action(function (params) { return __awaiter(void 0, void 0, void 0, function () {
        var options, entities, directory, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    directory = _a.sent();
                    (0, log_1.broadcast)(chalk_1.chalk.bold('Types successfully generated 🎊'));
                    (0, log_1.broadcast)(chalk_1.chalk.reset('They have been saved at'), chalk_1.chalk.cyan(directory));
                    return [3 /*break*/, 5];
                case 4:
                    error_1 = _a.sent();
...
exports.generateEntityTypes = generateEntityTypes;
